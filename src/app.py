...
from query.choropleth_query import Chropleth
from query.scattermatplot_query import Scatter
from query.bar_query import Bar
from query.date_query import Date
